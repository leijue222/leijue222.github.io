import{_ as e,W as i,X as n,a2 as s}from"./framework-6199cc12.js";const l={},d=s(`<p><strong>1. 拉取镜像</strong>（如拉取 Halo 镜像）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker pull halohub/halo:1.5.3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,28),r=[d];function a(t,c){return i(),n("div",null,r)}const v=e(l,[["render",a],["__file","docker.html.vue"]]);export{v as default};
