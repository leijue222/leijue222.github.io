import{_ as s,W as l,X as t,Y as e,Z as i,$ as d,a2 as n,C as c}from"./framework-6199cc12.js";const r={},o=n(`<h2 id="推荐方法-启动容器-在容器中配好所有环境-再把容器到出成镜像" tabindex="-1"><a class="header-anchor" href="#推荐方法-启动容器-在容器中配好所有环境-再把容器到出成镜像" aria-hidden="true">#</a> 推荐方法：启动容器，在容器中配好所有环境，再把容器到出成镜像</h2><ol><li>启动容器：</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -it -d --name demo mirrors.tencent.com/ailab_sv/ubuntu18.04:conda
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="第三步-其他个性化选配-按需选择" tabindex="-1"><a class="header-anchor" href="#第三步-其他个性化选配-按需选择" aria-hidden="true">#</a> 第三步：其他个性化选配（按需选择）</h3>`,22),m={href:"http://mirrors.tencent.com/ailab_sv/ubuntu18.04:conda%EF%BC%89%E5%B7%B2%E9%A2%84%E8%A3%85%E4%BB%A5%E4%B8%8B%E4%BE%9D%E8%B5%96",target:"_blank",rel:"noopener noreferrer"},v=n(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>RUN apt-get update &amp;&amp; apt-get install -y --no-install-recommends wget \\ 
    openssh-server \\
    zip \\
    unzip \\
    vim \\
...
RUN python -m pip --no-cache-dir install git+https://github.com/mechanicalsea/lighthubert#egg=lighthubert
RUN python -m pip --no-cache-dir install git+https://github.com/s3prl/s3prl.git#egg=s3prl
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function u(p,b){const a=c("ExternalLinkIcon");return l(),t("div",null,[o,e("p",null,[i("系统依赖（必需+常用）： 第一部推荐的base镜像（"),e("a",m,[i("mirrors.tencent.com/ailab_sv/ubuntu18.04:conda）已预装以下依赖"),d(a)])]),v])}const h=s(r,[["render",u],["__file","dockerMake.html.vue"]]);export{h as default};
